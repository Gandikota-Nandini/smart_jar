...
export default function QrScanner() {
    ...
    return (
        <div className="w-full h-full min-h-screen md:min-h-[calc(100vh-2rem)] md:rounded-[2.5rem] bg-slate-900 flex flex-col relative md:my-4 overflow-hidden animate-[fadeIn_0.3s_ease]">
